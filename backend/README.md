...
## Project Structure
    ...
    ├── nameless_firefly_31108  # Django project configurations
...
1. Clone this repo and `cd nameless_firefly_31108`
...
2. Clone this repo and `cd nameless_firefly_31108`
